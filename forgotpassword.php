...
<div>
  ...
  <form class="form-horizontal" action="forgotpwd2.php" method="post">
   <?php
        if(isset($_GET['email']))
        {
      ...
      echo '<div style="border: 1px #ff0000 solid;padding: 3px;text-align: center;margin-left: 63px;margin-right: 63px;color:#ff0000;">';
          ...
          echo "<h3>No user exist with the given details</h3>";
    ...
    <div class="form-group log-res">
      <label class="control-label col-sm-4 col-xs-12" for="email">Email or Mobile<span class="error"> *</span></label>
      <div class="col-sm-8 col-xs-12" style="padding-right: 80px;">
        <input type="text" class="form-control" id="data" placeholder="Enter Email or Mobile" name="data">
      </div>
    </div>
    <div class="form-group lgn-btn">        
      <div class="col-md-offset-4 col-sm-8 col-xs-12">
        <div>
        <button type="submit" class="newsubmit">Send OTP</button>
        </div>
      </div>
