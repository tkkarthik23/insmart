    ...
    <div class="row"  style="background-color: #f1f1f1;">
      ...
      <div class="reg-frm">
        <div class="frm-titles" style="margin-bottom: 20px;">
          <div class="lgn-title">
            <h4><a href="log.php">Login</a></h4>
          </div>
          <div class="reg-title">
            <h4><a href="registration.php">Click here to Registration</a></h4>
          </div>
        </div>
  <form class="form-horizontal" method="post" action="login.php" name="form" id="form">
     ...
     <?php
      ...
      echo '<div style="border: 1px #ff0000 solid;padding: 3px;text-align: center;margin-left: 63px;margin-right: 63px;color:#ff0000;">';
          ...
          echo "<h3>Email or Password Is Incorrect</h3>";
      ...
      echo '<div style="border: 1px #ff0000 solid;padding: 3px;text-align: center;margin-left: 63px;margin-right: 63px;color:#ff0000;">';
          ...
          echo "<h3>Please Log In and Insert the store details</h3>";
    ...
    <div class="form-group log-res">
      <label class="control-label col-sm-4 col-xs-12" for="email">Email Id<span class="error"> *</span></label>
      <div class="col-sm-8 col-xs-12" style="padding-right: 80px;">
        <input type="email" class="form-control" id="email1" placeholder="Email" name="email" required />
      </div>
    </div>
    <div class="form-group log-res">
      <label class="control-label col-sm-4 col-xs-12" for="phone">Password<span class="error"> *</span></label>
      <div class="col-sm-8 col-xs-12" style="padding-right: 80px;">
        <input  type="password" class="form-control" id="password1" placeholder="Password" name="password" required />
      </div>
    </div>
     
    <div class="form-group lgn-btn log-res">        
      <div class="col-md-offset-4 col-sm-8 col-xs-12">
        <div style="display: inline-block;">
        <button type="submit" class="btn btn-success">Login</button>
        </div>
        <div class="frm_forgot">
