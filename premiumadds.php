						  ...
						  require('data.php');
								if(isset($_SESSION['sesid']))
								{
									...
									while($rs = mysqli_fetch_array($query1))
										{
											$name=$rs['name'];
											echo'<li><a href="user/index.php" class="header_fb"><i class="fa fa-user" style="margin-right=6px"></i>';echo '   ';echo $name;echo'</a></li>';
										}
										
								} 
								else
								{
								echo'<li><a href="log.php" class="header_fb"><i class="fa fa-plus" style="margin-right=6px"></i>Publish your Details</a></li>
                           <li><a href="registration.php" class="header_fb"><i class="fa fa-user" style="margin-right=6px"></i>Registration</a></li>
                              <li><a href="log.php" class="header_fb"><i class="fa fa-sign-in" style="margin-right=6px"></i>Login</a></li>';
								}?>
                        </ul>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div>
                     <form class="col-sm-12">
                       <div class="col-sm-3  form-inline headerra " >
                           <select class="form-control selectform selcls"  required><option>Select Category</option>
                           </select>
                        </div>
                        <div class="col-sm-3  form-inline headerra " >
                           <select class="form-control selectform selcls" name ="country" required><option>Select Sub Category</option>
                           </select>
                        </div>
                        <div class="col-sm-2 form-inline headerra " >
                           <select class="form-control selectform selcls" name ="country" required><option>Select State</option>
                           </select>
                        </div>
                        <div class="col-sm-2  form-inline headerra " >
                           <select class="form-control selectform selcls" name ="country" required><option>Select Area</option>
                           </select>
                        </div>
                        <div class="col-sm-2 headerra" >
         ...
         <div class="row">
          <div class="col-md-3 side-bar" style="width: 20%;">
               ...
               <div class="col-md-9">
                    ...
                    <?php echo '<h3 style="text-align:center;">'; echo $id; echo '</h3>';?>
                    
                
                <div class="tab-content clearfix">
              <div class="tab-pane active" id="1a" style="">
					...
					?>	<div class="tab-content clearfix">
              <div class="tab-pane active" style="padding-top: 20px">
						<div class="card">
						<div >
                       <div class="container-fluid">
                             ...
                             <a href="card.php?id=<?php echo $email ?>"> <h3 class="head1"><?php echo $storename; ?></h3></a>
                              <div>
                               ...
                               <div class="shp_more" style="display: inline-block;padding-left: 300px;font-weight: bold; color:#0c90ce;">
                                 <p class="shp_more"> <i class="fa fa-arrow-circle-right"></i> <a href="card.php?id=<?php echo $email?>">More Info</p></a>
                               </div>
                              </div>
							  </div>
                           </div>
						...
						{
							echo 'Oops!! We dont have any premium stores related to your search.  ';
						}	
						?>
