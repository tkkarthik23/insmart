   ...
   <body>
     ...
     <div id="preloader">
      ...
      <header class="lesun-header-area">
         ...
         <div class="lesun-main-header-area" style="margin: 10px;">
            <div class="container">
               <div class="row">
                  <div>
    ...
    <div class="row"  style="background-color: #f1f1f1;">
      ...
      <div class="col-md-8">
        ...
        <div class="frm-titles">
          <h3 style="text-align: center;">Publish Store Details</h3>
        </div>
  <form class="form-horizontal" action="addstore.php" method="POST" enctype="multipart/form-data" >
    <div class="form-group" style="padding-top: 15px;">
      <label class="control-label col-sm-4" for="title">Store Name<span class="error"> *</span></label>
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="selectsubcategeories">Select Categeories<span class="error"> *</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">  
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="selectsubcategeories">Select Sub Categeories<span class="error"> *</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="title">Store Image<span class="error"> *</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
    ...
    <div class="form-group" style="padding-top: 15px;">
      <label class="control-label col-sm-4" for="title">Facebook</label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <input type="text" class="form-control" id="title" placeholder="facebook" name="fb">
      </div>
    </div>
    <div class="form-group" style="padding-top: 15px;">
      <label class="control-label col-sm-4" for="title">Twitter</label>
      <div class="col-sm-8" style="padding-right: 80px;">
