...
<div>
    ...
    <div class="row"  style="background-color: #f1f1f1;">
      ...
      <div class="col-md-8" style="border: 1px solid #ccc!important;margin: 10px;box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19)!important;margin-top: 80px;">
       ...
       <h2 style="text-align: center;margin: 14px;color: #0c90ce;">Add Services</h2>
  <form class="form-horizontal" action="addserv.php" method="POST" enctype="multipart/form-data">
    <div class="form-group" style="padding-top: 15px;">
      <label class="control-label col-sm-4" for="title">Title<span class="error">*</span></label>
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="phone">Phone Number<span class="error">*</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <input type="phone" class="form-control" id="phone" placeholder="Enter Phone Number" name="phone">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-4" for="selectcategeories">Select categeories<span class="error">*</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <select class="form-control" id="category" name="category">
		<option value="home and construction" >home and construction</option>
		</select> 
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="area">Area<span class="error">*</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8" style="padding-right: 80px;">
		...
		<option value="andhra pradesh" >andhra pradesh</option> </select>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-4" for="selectcity">Select City<span class="error">*</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8" style="padding-right: 80px;">
        <textarea class="form-control" id="address" rows="5" id="text" name="address">
        </textarea>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-4" for="title">Description<span class="error">*</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <textarea class="form-control" id="others" rows="5" name="desc">
        </textarea>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-4" for="title">Image<span class="error">*</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-12">
                     <div class="single-footer-widget footer-logo-widget">
                        <div class="footer-logo">
                           <a href="index.php">
                           <img src="images/insmartlogo.png" alt="footer logo" style="margin-top: 10px;" />
                           </a>
                        </div>
