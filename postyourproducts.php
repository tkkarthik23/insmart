...
<div>
    ...
    <div class="row"  style="background-color: #f1f1f1;">
      ...
      <div class="col-md-8" style="border: 1px solid #ccc!important;margin: 10px;box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19)!important;margin-top: 80px;">
       <h2 style="text-align: center;margin: 14px;color: #0c90ce;">PostOfferDetails</h2>
  <form class="form-horizontal" action="/action_page.php">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8" style="padding-right: 80px;">
        <input type="phone no" class="form-control" id="phone" placeholder="Enter  phone no" name="phone">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="cost">Premium*</label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <input type="Premium" class="form-control" id="Premium" placeholder="Enter Premium" name="Premium">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="title">Features*</label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <textarea class="form-control" id="features" rows="5" name="features">
        </textarea>
      </div>
    </div>
