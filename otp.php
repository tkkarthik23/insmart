...
<div>
  ...
  <form class="form-horizontal" action="/action_page.php">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="email">Enter OTP<span class="error"> *</span></label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <input type="text" class="form-control" id="email" placeholder="Enter OTP" name="Email">
      </div>
    </div>
    <div class="form-group">        
