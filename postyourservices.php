...
<div>
  ...
  <form class="form-horizontal" action="/action_page.php">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="title">Others*</label>
      <div class="col-sm-8" style="padding-right: 80px;">
        <textarea class="form-control" id="others" name="others" rows="5">
        </textarea>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-4 col-sm-8">
        <button type="submit" class="newsubmit" name="submit" id="submit">Submit</button>
      </div>
    </div>
  </form>
